...
{
    public partial class YearScheduleViewModel : BaseViewModel
    {
        [ObservableProperty]
        ...
        public YearScheduleViewModel(ISchedule<IShift> schedule)
        {
            ...
            this.totalShiftHours = new TimeSpan(12, 0, 0);
        }
        ...
        private async Task<string[]> ValidateSchedule()
        {
            ...
            if (string.IsNullOrEmpty(selectedScheduleString))
            {
                await ShowPopupMessage(AppResources.Error, 
                                       AppResources.PleaseSelectAScheduleFirst);
