namespace WorkChronicle.ViewModels
{
    ...
    {
        private IWorkScheduleRepositoryDB scheduleRepo;
        ...
        public LoadScheduleViewModel(ISchedule<IShift> schedule)
        {
        ...
        private async Task LoadScheduleNames()
        {
            ...
            try
            {
                ...
                // and the user can pick which one to delete or to load
        ...
        private async Task DeleteSelectedSchedule()
        {
            ...
            try
            {
               ...
               //The method deletes the chosen schedule from the DB
        ...
        private async Task LoadSelectedSchedule()
        {
            ...
            try
            {
               //The method loads the chosen schedule from the DB
        ...
        private async Task LoadFromDBToSchedule()
        {
            ...
            try
            {
                ...
                // and replace the one in the schedule.WorkSchedule
